...
def _wait_for_code(port: int, state: str, redirect_uri: str, timeout: int = 300) -> str:
    ...
    if not _CallbackHandler.code:
        raise FacebookError(
            ...
            "    your app is missing those permissions. Add the use case\n"
            "    'Manage everything on your Page' to the Meta app, then retry.\n"
            "    (You do NOT need a long-lived token first.)\n"
