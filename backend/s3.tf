...
# IAM-scoped credentials handed out by the Cognito Identity Pool.
...
# Allow the browser (running on the site origin) to PUT/GET directly.
...
# Housekeeping: clean up failed multipart uploads.
